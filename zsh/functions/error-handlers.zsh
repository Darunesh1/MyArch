...
function _slow_load_warning {
    ...
    ⚠️ Warning: Shell startup took more than ${time_limit} seconds. Consider optimizing your configuration.
        ...
        2. Duplicate plugin initialization.
            - Remove any 'source ZSH/oh-my-zsh.sh' or 'source ~/.oh-my-zsh/oh-my-zsh.sh' lines.
            - This configuration already sources oh-my-zsh for you.
        3. Check '~/.user.zsh' for any slow initialization scripts.

    For more information on slow shell startup causes, see:
